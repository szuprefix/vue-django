        ...
        <!--<el-row :gutter="20">-->
            <!--<el-col :span="16">-->
                ...
                <!--<template v-for="f in filterFields">-->
                    ...
                    <!--</el-checkbox>-->
                    <!--&lt;!&ndash;<el-select v-model="queries[f.name]" v-if="f.type=='boolean'"&ndash;&gt;-->
                    <!--&lt;!&ndash;:placeholder="`请选择${f.label}`" style="width:150px">&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-option  label="是" :value="true"></el-option>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-option label="否" :value="false"></el-option>&ndash;&gt;-->
                    <!--&lt;!&ndash;<el-option label="忽略" :value="null"></el-option>&ndash;&gt;-->
