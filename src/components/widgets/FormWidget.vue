...
<div class="form-field">
  ...
  <el-date-picker v-model="value[field.name]" :type="field.widget" value-format="yyyy-MM-ddTHH:mm:ssZ" :placeholder="field.label" v-else-if="['date','datetime'].includes(field.widget)" @change="fieldValueChanged">
  </el-date-picker>
